    ...
    return (
        <div className="max-w-4xl mx-auto p-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                <h2 className="text-3xl font-bold text-blue-600 mb-6">Add New Marathon</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {/* Running Distance */}
                        <div>
                            <label className="block text-sm font-medium mb-2">Running Distance</label>
                            <select
                        ...
                        {/* Image URL */}
                        <div>
                            <label className="block text-sm font-medium mb-2">Marathon Image URL</label>
                            <input
                                type="url"
                                name="image"
                        ...
                        {/* Marathon Start Date */}
                        <div>
                            <label className="block text-sm font-medium mb-2">Marathon Start Date</label>
                            <DatePicker
